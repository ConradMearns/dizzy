...
class FileItem(ConfiguredBaseModel):
    ...
    partition_uuid: str = Field(default=..., description="""UUID of the partition where item was found""", json_schema_extra = { "linkml_meta": {'domain_of': ['FileItem', 'FileItemScanned', 'FileItemProblem']} })
...
class FileItemScanned(DomainEvent):
    ...
    partition_uuid: str = Field(default=..., description="""UUID of the partition containing this file""", json_schema_extra = { "linkml_meta": {'domain_of': ['FileItem', 'FileItemScanned', 'FileItemProblem']} })
