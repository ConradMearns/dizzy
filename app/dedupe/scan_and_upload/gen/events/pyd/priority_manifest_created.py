...
# description: Prioritized manifest successfully created
...
class PriorityManifestCreated(Event):
    """
    Prioritized manifest successfully created
    """
    _inherited_slots: ClassVar[list[str]] = []

    class_class_uri: ClassVar[URIRef] = DEDUPE["PriorityManifestCreated"]
    class_class_curie: ClassVar[str] = "dedupe:PriorityManifestCreated"
    class_name: ClassVar[str] = "priority_manifest_created"
    class_model_uri: ClassVar[URIRef] = DEDUPE.PriorityManifestCreated
...
slots.priorityManifestCreated__event_id = Slot(uri=DEDUPE.event_id, name="priorityManifestCreated__event_id", curie=DEDUPE.curie('event_id'),
                   model_uri=DEDUPE.priorityManifestCreated__event_id, domain=None, range=str)
