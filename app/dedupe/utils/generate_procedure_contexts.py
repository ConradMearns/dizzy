...
def generate_context_classes(procedures: Dict, output_path: Path):
    ...
    lines.append('from gen.queries import (')
...
def generate_protocol_interfaces(procedures: Dict, output_path: Path):
    ...
    lines.append('from gen.commands import (')
    for proc_name in procedures:
...
def main():
    ...
    procedures_yaml = project_root / 'def' / 'procedures.d.yaml'
    contexts_file = project_root / 'gen' / 'procedures.py'
    protocols_file = project_root / 'procedures' / 'interfaces.py'

    data = parse_procedures_yaml(procedures_yaml)
    procedures = data.get('procedures', {})
    generate_context_classes(procedures, contexts_file)
    generate_protocol_interfaces(procedures, protocols_file)
