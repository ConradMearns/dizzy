...
class ModelDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Schema name (plural, lowercase, snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class QueryDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Query name (snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class CommandDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Command name (snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class EventDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Event name (snake_case, past-tense)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class ProcedureDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Procedure name (snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class PolicyDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Policy name (snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
...
class ProjectionDef(ConfiguredBaseModel):
    ...
    name: str = Field(default=..., description="""Projection name (snake_case)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ModelDef',
                       'QueryDef',
                       'CommandDef',
                       'EventDef',
                       'ProcedureDef',
